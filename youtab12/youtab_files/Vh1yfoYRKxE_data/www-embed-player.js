...
Ya(Xh,Wh);Xh.prototype.reset=function(){this.i[0]=1732584193;this.i[1]=4023233417;this.i[2]=2562383102;this.i[3]=271733878;this.i[4]=3285377520;this.m=this.j=0};
...
Ya(qi,pi);function ri(a){this.data=a}
...
Ya(ti,qi);ti.prototype.set=function(a,b,c){if(b=si(b)){if(c){if(c<Date.now()){ti.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}ti.Y.set.call(this,a,b)};
...
;function vi(){}
Ya(vi,ui);vi.prototype[Symbol.iterator]=function(){return fi(this.ea(!0)).i()};
...
Ya(wi,vi);l=wi.prototype;l.isAvailable=function(){if(!this.i)return!1;try{return this.i.setItem("__sak","1"),this.i.removeItem("__sak"),!0}catch(a){return!1}};
...
Ya(yi,vi);var Ai={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},zi=null;function Bi(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return Ai[b]})}
...
Ya(Di,vi);Di.prototype.set=function(a,b){this.j.set(this.i+a,b)};
...
;var Wj=y.window,Xj,Yj,tk=(null==Wj?void 0:null==(Xj=Wj.yt)?void 0:Xj.config_)||(null==Wj?void 0:null==(Yj=Wj.ytcfg)?void 0:Yj.data_)||{};z("yt.config_",tk);function uk(){Vj(tk,arguments)}
...
function Cp(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.i=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.j=a.clientY+b}}
...
op.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var qb=y.ytEventsEventsListeners||{};z("ytEventsEventsListeners",qb);var aq=y.ytEventsEventsCounter||{count:0};z("ytEventsEventsCounter",aq);
...
function dq(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=bq(a,b,c,d);if(e)return e;e=++aq.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new op(h);if(!df(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new op(h);
...
Ya(gq,J);gq.prototype.P=function(a){void 0===a.i&&Cp(a);var b=a.i;void 0===a.j&&Cp(a);this.j=new $e(b,a.j)};
...
a.params){var da=a.params;if("object"===typeof a.params)for(var W in da){if(da[W]){var pb="params."+W,Za=Gr(da[W]);g[pb]=Za;N+=pb.length+Za.length;if(500<N)break}}else g.params=Gr(da)}if(m.length)for(var ma=0;ma<m.length&&!(N=Er(m[ma],"params.context."+ma,g,N),500<=N);ma++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:r,name:w,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},la=Number(a.columnNumber);isNaN(la)||(H.lineNumber=H.lineNumber+
":"+la);if("IGNORED"===a.level)var fa=0;else a:{for(var ze=Ar(),Ae=p(ze.oa),wd=Ae.next();!wd.done;wd=Ae.next()){var oa=wd.value;if(H.message&&H.message.match(oa.kr)){fa=oa.weight;break a}}for(var pp=p(ze.na),Zj=pp.next();!Zj.done;Zj=pp.next()){var qp=Zj.value;if(qp.callback(H)){fa=qp.weight;break a}}fa=1}H.sampleWeight=fa;for(var rp=p(vr),ak=rp.next();!ak.done;ak=rp.next()){var bk=ak.value;if(bk.jb[H.name])for(var sp=p(bk.jb[H.name]),ck=sp.next();!ck.done;ck=sp.next()){var tp=ck.value,Rg=H.message.match(tp.regexp);
if(Rg){H.params["params.error.original"]=Rg[0];for(var dk=tp.groups,up={},xd=0;xd<dk.length;xd++)up[dk[xd]]=Rg[xd+1],H.params["params.error."+dk[xd]]=Rg[xd+1];H.message=bk.Cb(up);break}}}H.params||(H.params={});var vp=Ar();H.params["params.errorServiceSignature"]="msg="+vp.oa.length+"&cb="+vp.na.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Hr.has(H.message)){if("ERROR"===h){Br.ta("handleError",H);if(M("record_app_crashed_web")&&0===Kr&&1===H.sampleWeight)if(Kr++,M("errors_via_jspb")){var ek=new kj;D(ek,1,1);if(!M("report_client_error_with_app_crash_ks")){var wp=new fj;D(wp,1,H.message);var xp=new gj;G(xp,fj,3,wp);var yp=new hj;G(yp,gj,5,xp);var zp=new ij;G(zp,hj,9,yp);G(ek,ij,4,zp)}var Ap=new Ij;Ud(Ap,kj,20,
Jj,ek);nr(Ap)}else{var Bp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Bp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});km("appCrashed",Bp)}Jr++}else"WARNING"===h&&Br.ta("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var Be=h;if(M("errors_via_jspb")){if(Pr())var Dp=void 0;else{var yd=new cj;D(yd,1,H.stack);H.fileName&&D(yd,4,H.fileName);var Jb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Jb.length&&(1!==
Jb.length||isNaN(Number(Jb[0]))?2!==Jb.length||isNaN(Number(Jb[0]))||isNaN(Number(Jb[1]))||(D(yd,2,Number(Jb[0])),D(yd,3,Number(Jb[1]))):D(yd,2,Number(Jb[0])));var Dc=new fj;D(Dc,1,H.message);D(Dc,3,H.name);D(Dc,6,H.sampleWeight);"ERROR"===Be?D(Dc,2,2):"WARNING"===Be?D(Dc,2,1):D(Dc,2,0);var fk=new dj;D(fk,1,!0);Ud(fk,cj,3,ej,yd);var cc=new $i;D(cc,3,window.location.href);for(var Ep=L("FEXP_EXPERIMENTS",[]),gk=0;gk<Ep.length;gk++){var Jv=Ep[gk];Dd(cc);Nd(cc,5,2,!1).push(Jv)}var hk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!vk()&&hk)for(var Fp=p(Object.keys(hk)),Ec=Fp.next();!Ec.done;Ec=Fp.next()){var Gp=Ec.value,ik=new bj;D(ik,1,Gp);ik.setValue(String(hk[Gp]));Wd(cc,4,bj,ik)}var jk=H.params;if(jk){var Hp=p(Object.keys(jk));for(Ec=Hp.next();!Ec.done;Ec=Hp.next()){var Ip=Ec.value,kk=new bj;D(kk,1,"client."+Ip);kk.setValue(String(jk[Ip]));Wd(cc,4,bj,kk)}}var Jp=L("SERVER_NAME"),Kp=L("SERVER_VERSION");if(Jp&&Kp){var lk=new bj;D(lk,1,"server.name");lk.setValue(Jp);Wd(cc,4,bj,lk);var mk=new bj;D(mk,1,"server.version");
mk.setValue(Kp);Wd(cc,4,bj,mk)}var Sg=new gj;G(Sg,$i,1,cc);G(Sg,dj,2,fk);G(Sg,fj,3,Dc);Dp=Sg}var Lp=Dp;if(!Lp)break a;var Mp=new Ij;Ud(Mp,gj,163,Jj,Lp);nr(Mp)}else{if(Pr())var Np=void 0;else{var Ce={stackTrace:H.stack};H.fileName&&(Ce.filename=H.fileName);var Kb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Kb.length&&(1!==Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(Ce.lineNumber=Number(Kb[0]),Ce.columnNumber=Number(Kb[1])):Ce.lineNumber=
Number(Kb[0]));var nk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===Be?nk.level="ERROR_LEVEL_ERROR":"WARNING"===Be&&(nk.level="ERROR_LEVEL_WARNNING");var Kv={isObfuscated:!0,browserStackInfo:Ce},zd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(zd.experimentIds=L("FEXP_EXPERIMENTS"));var ok=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!vk()&&ok)for(var Op=p(Object.keys(ok)),Fc=Op.next();!Fc.done;Fc=Op.next()){var Pp=
Fc.value;zd.kvPairs.push({key:Pp,value:String(ok[Pp])})}var pk=H.params;if(pk){var Qp=p(Object.keys(pk));for(Fc=Qp.next();!Fc.done;Fc=Qp.next()){var Rp=Fc.value;zd.kvPairs.push({key:"client."+Rp,value:String(pk[Rp])})}}var Sp=L("SERVER_NAME"),Tp=L("SERVER_VERSION");Sp&&Tp&&(zd.kvPairs.push({key:"server.name",value:Sp}),zd.kvPairs.push({key:"server.version",value:Tp}));Np={errorMetadata:zd,stackTrace:Kv,logMessage:nk}}var Up=Np;if(!Up)break a;km("clientError",Up)}if("ERROR"===Be||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
H.stack);for(var Vp=p(Object.keys(De)),qk=Vp.next();!qk.done;qk=Vp.next()){var Wp=qk.value;dc.postParams["client."+Wp]=De[Wp]}var rk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(rk)for(var Xp=p(Object.keys(rk)),sk=Xp.next();!sk.done;sk=Xp.next()){var Yp=sk.value;dc.postParams[Yp]=rk[Yp]}var Zp=L("SERVER_NAME"),$p=L("SERVER_VERSION");Zp&&$p&&(dc.postParams["server.name"]=Zp,dc.postParams["server.version"]=$p)}dl(L("ECATCHER_REPORT_HOST","")+"/error_204",dc)}try{Hr.add(H.message)}catch(nx){}Ir++}}}}
...
return a.join("")}
;var Wr=y.ytLoggingDocDocumentNonce_;Wr||(Wr=Vr(),z("ytLoggingDocDocumentNonce_",Wr));var Xr=Wr;var Yr={Zh:0,we:1,Ge:2,Wl:3,bi:4,qq:5,Mm:6,yo:7,Rn:8,mo:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function Zr(a){this.i=a}
...
Wa(S.clearResourceTimings||S.webkitClearResourceTimings||S.mozClearResourceTimings||S.msClearResourceTimings||S.oClearResourceTimings||cb,S);function ut(a){var b=vt("aft",a);if(b)return b;b=L((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=b.length,d=0;d<c;d++){var e=vt(b[d],a);if(e)return e}return NaN}
...
function vt(a,b){if(a=Dt(b)[a])return"number"===typeof a?a:a[a.length-1]}
...
function Gt(a){a=Et(a);a.jspbInfos||(a.jspbInfos=[]);return a.jspbInfos}
function Ht(a){var b=At(a).nonce;b||(b=Vr(),At(a).nonce=b);return b}
function It(a){var b=vt("_start",a),c=ut(a);b&&c&&!st&&(Yn(pt,new ot(Math.round(c-b),a)),st=!0)}
function Jt(a,b){for(var c=p(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!Jt(a[d],b[d]))return!1;return!0}
;function Kt(){if(S.getEntriesByType){var a=S.getEntriesByType("paint");if(a=kb(a,function(b){return"first-paint"===b.name}))return xt(a.startTime)}a=S.timing;
return a.cd?Math.max(0,a.cd):0}
;function Lt(){var a=B("ytcsi.debug");a||(a=[],z("ytcsi.debug",a),z("ytcsi.reference",{}));return a}
function Mt(a){a=a||"";var b=B("ytcsi.reference");b||(Lt(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=Lt(),d={timerName:a,info:{},tick:{},span:{},jspbInfo:[]};c.push(d);return b[a]=d}
;var T={},Nt=(T.auto_search="LATENCY_ACTION_AUTO_SEARCH",T.ad_to_ad="LATENCY_ACTION_AD_TO_AD",T.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",T["analytics.explore"]="LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE",T.app_startup="LATENCY_ACTION_APP_STARTUP",T["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",T["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",T["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",T["song.analytics"]="LATENCY_ACTION_CREATOR_SONG_ANALYTICS",T.browse="LATENCY_ACTION_BROWSE",
...
Pt="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Qt={},Rt=(Qt.ccs="CANARY_STATE_",Qt.mver="MEASUREMENT_VERSION_",Qt.pis="PLAYER_INITIALIZED_STATE_",Qt.yt_pt="LATENCY_PLAYER_",Qt.pa="LATENCY_ACTION_",Qt.ctop="TOP_ENTITY_TYPE_",
Qt.yt_vst="VIDEO_STREAM_TYPE_",Qt),St="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");function Tt(a){return Nt[a]||"LATENCY_ACTION_UNKNOWN"}
function Ut(a,b,c){c=Et(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Ot){c=Ot[a];0<=eb(Pt,c)&&(b=!!b);a in Rt&&"string"===typeof b&&(b=Rt[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return jt({},d)}0<=eb(St,a)||Or(new Q("Unknown label logged with GEL CSI",a))}
...
V[V.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var Vt={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};Vt[Vt.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";Vt[Vt.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";Vt[Vt.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
Y[Y.DETAILED_NETWORK_TYPE_1_X_RTT]="DETAILED_NETWORK_TYPE_1_X_RTT";Y[Y.DETAILED_NETWORK_TYPE_GPRS]="DETAILED_NETWORK_TYPE_GPRS";Y[Y.DETAILED_NETWORK_TYPE_EDGE]="DETAILED_NETWORK_TYPE_EDGE";Y[Y.DETAILED_NETWORK_TYPE_UNKNOWN]="DETAILED_NETWORK_TYPE_UNKNOWN";var Wt={LATENCY_PLAYER_RTSP:7,LATENCY_PLAYER_HTML5_INLINE:6,LATENCY_PLAYER_HTML5_FULLSCREEN:5,LATENCY_PLAYER_HTML5:4,LATENCY_PLAYER_FRAMEWORK:3,LATENCY_PLAYER_FLASH:2,LATENCY_PLAYER_EXO:1,LATENCY_PLAYER_UNKNOWN:0};Wt[Wt.LATENCY_PLAYER_RTSP]="LATENCY_PLAYER_RTSP";
Wt[Wt.LATENCY_PLAYER_HTML5_INLINE]="LATENCY_PLAYER_HTML5_INLINE";Wt[Wt.LATENCY_PLAYER_HTML5_FULLSCREEN]="LATENCY_PLAYER_HTML5_FULLSCREEN";Wt[Wt.LATENCY_PLAYER_HTML5]="LATENCY_PLAYER_HTML5";Wt[Wt.LATENCY_PLAYER_FRAMEWORK]="LATENCY_PLAYER_FRAMEWORK";Wt[Wt.LATENCY_PLAYER_FLASH]="LATENCY_PLAYER_FLASH";Wt[Wt.LATENCY_PLAYER_EXO]="LATENCY_PLAYER_EXO";Wt[Wt.LATENCY_PLAYER_UNKNOWN]="LATENCY_PLAYER_UNKNOWN";
var Xt={LATENCY_AD_BREAK_TYPE_POSTROLL:3,LATENCY_AD_BREAK_TYPE_MIDROLL:2,LATENCY_AD_BREAK_TYPE_PREROLL:1,LATENCY_AD_BREAK_TYPE_UNKNOWN:0};Xt[Xt.LATENCY_AD_BREAK_TYPE_POSTROLL]="LATENCY_AD_BREAK_TYPE_POSTROLL";Xt[Xt.LATENCY_AD_BREAK_TYPE_MIDROLL]="LATENCY_AD_BREAK_TYPE_MIDROLL";Xt[Xt.LATENCY_AD_BREAK_TYPE_PREROLL]="LATENCY_AD_BREAK_TYPE_PREROLL";Xt[Xt.LATENCY_AD_BREAK_TYPE_UNKNOWN]="LATENCY_AD_BREAK_TYPE_UNKNOWN";var Yt={LATENCY_ACTION_ERROR_STARTUP_TIMEOUT:1,LATENCY_ACTION_ERROR_UNSPECIFIED:0};
Yt[Yt.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Yt[Yt.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var Zt={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};Zt[Zt.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";Zt[Zt.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";Zt[Zt.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
Zt[Zt.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";Zt[Zt.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";Zt[Zt.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var $t={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};$t[$t.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";$t[$t.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";$t[$t.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";$t[$t.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var au={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};au[au.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";au[au.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";au[au.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var bu={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};bu[bu.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
bu[bu.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";bu[bu.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var cu="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo webViewInfo prefetchInfo accelerationSession commerceInfo webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var du=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",du);function eu(){this.i=0}
function fu(){eu.i||(eu.i=new eu);return eu.i}
eu.prototype.tick=function(a,b,c,d){gu(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Fj,D(d,1,a),D(d,2,b),a=new Ij,Ud(a,Fj,5,Jj,d),nr(a,c)):km("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
eu.prototype.info=function(a,b,c){var d=Object.keys(a).join("");gu(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,km("latencyActionInfo",a,{cttAuthInfo:c}))};
eu.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));gu(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Ij,Ud(c,Bj,7,Jj,a),nr(c,b))};
eu.prototype.span=function(a,b,c){var d=Object.keys(a).join("");gu(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,km("latencyActionSpan",a,{cttAuthInfo:c}))};
function gu(a,b){du[b]=du[b]||{count:0};var c=du[b];c.count++;c.time=P();a.i||(a.i=Wl(function(){var d=P(),e;for(e in du)du[e]&&6E4<d-du[e].time&&delete du[e];a&&(a.i=0)},0,5E3));
...
;function hu(){var a=["ol"];Mt("").info.actionType="embed";a&&uk("TIMING_AFT_KEYS",a);uk("TIMING_ACTION","embed");if(M("web_csi_via_jspb")){a=L("TIMING_INFO",{});var b=new Bj;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetGuide_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetHome_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);
break;case "GetPlayer_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetSearch_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetSettings_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetTrending_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "GetWatchNext_rid":e=new Ej;D(e,1,c);D(e,2,String(d));Dj(b,e);break;case "yt_red":D(b,14,!!d);break;case "yt_ad":D(b,9,!!d)}}iu(b);b=new Bj;b=D(b,25,!0);b=D(b,1,V[Tt(L("TIMING_ACTION"))]);(a=L("PREVIOUS_ACTION"))&&
D(b,13,V[Tt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=fs())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=ju();1!==a&&-1!==a||D(b,6,!0);a=Bt();if(M("skip_setting_info_in_csi_data_object"))Ct();else{d=Gt();c=[];for(e=0;e<d.length;e++){var f=c,g=f.push;var h=d[e];var k=Bj;if(null==h||""==h)k=new k;else{h=JSON.parse(h);if(!Array.isArray(h))throw Error(void 0);$d=h=sd(h);k=new k(h);$d=null}g.call(f,k)}for(d=0;d<c.length&&"cold"!==Yd(Md(c[d],3),"");d++);}D(b,3,"cold");ku(a);a=
lu();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Aj,D(d,1,c),Wd(b,83,Aj,d);iu(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&mu(b,a[b]);b={isNavigation:!0,actionType:Tt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=Tt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=L("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=fs())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=ju();if(1===a||-1===a)b.isVisible=!0;M("skip_setting_info_in_csi_data_object")?
Ct():Bt();b.loadType="cold";ku(Bt());a=lu();if(0<a.length)for(b.resourceInfo=[],a=p(a),c=a.next();!c.done;c=a.next())b.resourceInfo.push({resourceCache:c.value});nu(b)}b=Bt();a=Ft();if(!(M("skip_setting_info_in_csi_data_object")&&"cold"!==Ct().loadType||"cold"!==b.yt_lt&&"cold"!==a.loadType)){c=Dt();d=Et();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var m in c)if(!(m in d))if("number"===typeof c[m])Z(m,vt(m));else if(M("log_repeated_ytcsi_ticks"))for(e=p(c[m]),f=e.next();!f.done;f=e.next())Z(m.slice(1),
f.value);m={};c=!1;d=p(Object.keys(b));for(e=d.next();!e.done;e=d.next())e=e.value,(e=Ut(e,b[e]))&&!Jt(Ft(),e)&&(jt(a,e),jt(m,e),c=!0);c&&nu(m)}z("ytglobal.timingready_",!0);m=L("TIMING_ACTION");B("ytglobal.timingready_")&&m&&"_start"in Dt()&&ut()&&It()}
function mu(a,b,c,d){null!==b&&(Bt(c)[a]=b,(a=Ut(a,b,c))&&nu(a,c,d))}
function nu(a,b,c){if(!M("web_csi_via_jspb")||(void 0===c?0:c))c=Mt(b||""),jt(c.info,a),M("skip_setting_info_in_csi_data_object")&&a.loadType&&(c=a.loadType,Ct(b).loadType=c),jt(Ft(b),a),c=Ht(b),b=At(b).cttAuthInfo,fu().info(a,c,b);else{c=new Bj;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":D(c,1,V[a[e]]);break;case "clientActionNonce":D(c,2,a[e]);break;case "clientScreenNonce":D(c,4,a[e]);break;case "loadType":D(c,3,a[e]);break;case "isPrewarmedLaunch":D(c,
92,a[e]);break;case "isFirstInstall":D(c,55,a[e]);break;case "networkType":D(c,5,Vt[a[e]]);break;case "connectionType":D(c,26,X[a[e]]);break;case "detailedConnectionType":D(c,27,Y[a[e]]);break;case "isVisible":D(c,6,a[e]);break;case "playerType":D(c,7,Wt[a[e]]);break;case "clientPlaybackNonce":D(c,8,a[e]);break;case "adClientPlaybackNonce":D(c,28,a[e]);break;case "previousCpn":D(c,77,a[e]);break;case "targetCpn":D(c,76,a[e]);break;case "isMonetized":D(c,9,a[e]);break;case "isPrerollAllowed":D(c,16,
a[e]);break;case "isPrerollShown":D(c,17,a[e]);break;case "adType":D(c,12,a[e]);break;case "adTypesAllowed":D(c,36,a[e]);break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,V[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,Xt[a[e]]);break;case "isNavigation":D(c,25,a[e]);break;case "viewportHeight":D(c,
...
64,a[e]);break;case "shellStartupDurationMs":D(c,70,a[e]);break;case "appInstallDataAgeMs":D(c,73,a[e]);break;case "latencyActionError":D(c,71,Yt[a[e]]);break;case "actionStep":D(c,79,a[e]);break;case "jsHeapSizeLimit":D(c,80,a[e]);break;case "totalJsHeapSize":D(c,81,a[e]);break;case "usedJsHeapSize":D(c,82,a[e]);break;case "sourceVideoDurationMs":D(c,90,a[e]);break;case "videoOutputFrames":D(c,93,a[e]);break;case "isResume":D(c,104,a[e]);break;case "adPrebufferedTimeSecs":D(c,39,a[e]);break;case "isLivestream":D(c,
47,a[e]);break;case "liveStreamMode":D(c,91,Zt[a[e]]);break;case "adCpn2":D(c,48,a[e]);break;case "adDaiDriftMillis":D(c,49,a[e]);break;case "videoStreamType":D(c,53,$t[a[e]]);break;case "playbackRequiresTap":D(c,56,a[e]);break;case "performanceNavigationTiming":D(c,67,a[e]);break;case "transactionType":D(c,74,au[a[e]]);break;case "playerRotationType":D(c,101,bu[a[e]]);break;case "allowedPreroll":D(c,10,a[e]);break;case "shownPreroll":D(c,11,a[e]);break;case "getHomeRequestId":D(c,57,a[e]);break;
case "getSearchRequestId":D(c,60,a[e]);break;case "getPlayerRequestId":D(c,61,a[e]);break;case "getWatchNextRequestId":D(c,62,a[e]);break;case "getBrowseRequestId":D(c,63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:cu.includes(f)&&Dk(new Q("Codegen laipb translator asked to translate message field",""+f))}}catch(g){Dk(Error("Codegen laipb translator failed to set "+f))}}iu(c,b)}}
function iu(a,b){if(M("skip_setting_info_in_csi_data_object")){var c=Yd(Md(a,3),"");c&&(Ct(b).loadType=c)}else Gt(b).push(ae(a));Mt(b||"").jspbInfo.push(a);c=Ht(b);b=At(b).cttAuthInfo;fu().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}d=Mt(c||"");d.tick[a]=b||P();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=Et(c);d.gelTicks&&(d.gelTicks[a]=!0);e=Dt(c);d=b||P();M("log_repeated_ytcsi_ticks")?a in e||(e[a]=d):e[a]=d;e=Ht(c);var f=At(c).cttAuthInfo;"_start"===a?(a=fu(),gu(a,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(a=new zj,
D(a,1,e),e=new Ij,Ud(e,zj,6,Jj,a),nr(e,b)):km("latencyActionBaselined",{clientActionNonce:e},b))):fu().tick(a,e,b,f);It(c);return d}
function ou(){var a=Ht();requestAnimationFrame(function(){setTimeout(function(){a===Ht()&&Z("ol",void 0,void 0)},0)})}
function ju(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=mp+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function ku(a){var b=wt(),c=zt(),d=L("CSI_START_TIMESTAMP_MILLIS",0);0<d&&!M("embeds_web_enable_csi_start_override_killswitch")&&(c=d);c&&(Z("srt",b.responseStart),1!==a.prerender&&Z("_start",c,void 0));a=Kt();0<a&&Z("fpt",a);a=wt();a.isPerformanceNavigationTiming&&nu({performanceNavigationTiming:!0});Z("nreqs",a.requestStart,void 0);Z("nress",a.responseStart,void 0);Z("nrese",a.responseEnd,void 0);0<a.redirectEnd-a.redirectStart&&(Z("nrs",a.redirectStart,void 0),Z("nre",a.redirectEnd,void 0));0<
a.domainLookupEnd-a.domainLookupStart&&(Z("ndnss",a.domainLookupStart,void 0),Z("ndnse",a.domainLookupEnd,void 0));0<a.connectEnd-a.connectStart&&(Z("ntcps",a.connectStart,void 0),Z("ntcpe",a.connectEnd,void 0));a.secureConnectionStart>=zt()&&0<a.connectEnd-a.secureConnectionStart&&(Z("nstcps",a.secureConnectionStart,void 0),Z("ntcpe",a.connectEnd,void 0));S&&"getEntriesByType"in S&&pu()}
function qu(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);ic()&&a.setAttribute("nonce",ic());return c?(a=S.getEntriesByName(c))&&a[0]&&(a=a[0],c=zt(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function lu(){var a=[];if(document.querySelector&&S&&S.getEntriesByName)for(var b in tt)if(tt.hasOwnProperty(b)){var c=tt[b];qu(b,c)&&a.push(c)}return a}
function pu(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=gb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
var ru=window;ru.ytcsi&&(ru.ytcsi.info=mu,ru.ytcsi.tick=Z);var su="tokens consistency mss client_location entities response_received_commands store PLAYER_PRELOAD".split(" "),tu=["type.googleapis.com/youtube.api.pfiinnertube.YoutubeApiInnertube.BrowseResponse"];function uu(a,b,c,d){this.o=a;this.M=b;this.m=c;this.l=d;this.j=void 0;this.i=new Map;a.Pa||(a.Pa={});a.Pa=Object.assign({},ht,a.Pa)}
function vu(a,b,c,d){if(void 0!==uu.i){if(d=uu.i,a=[a!==d.o,b!==d.M,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new Q("InnerTubeTransportService is already initialized",a);
}else uu.i=new uu(a,b,c,d)}
function wu(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Is:c;var d=Rs(b,a.o);if(!d)return wf(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new rf(function(f){var g,h,k;return x(function(m){if(1==m.i){h="cors"===(null==(g=e.ya)?void 0:g.mode)?"cors":void 0;if(a.m.xd){var q=e.config,r;q=null==q?void 0:null==(r=q.Ya)?void 0:r.sessionIndex;r=Hs({sessionIndex:q});k=Object.assign({},xu(h),r);return m.u(2)}return v(m,yu(e.config,
h),3)}2!=m.i&&(k=m.j);f(zu(a,e,k));m.i=0})}):wf(new Q("Error: Failed to build request for command.",b))}
function Au(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.ur)?0:d.xr)&&a.l){d=p(su);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function zu(a,b,c){var d,e,f,g,h,k,m,q,r,w,u,A,E,F,O,N,R,da,W,pb,Za,ma,H,la,fa,ze,Ae,wd;return x(function(oa){switch(oa.i){case 1:oa.u(2);break;case 3:if((d=oa.j)&&!d.isExpired())return oa.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ha)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.qr(b.ha.context);if(null==(m=a.j)||!m.vr(b.input,b.ha)){oa.u(4);break}return v(oa,a.j.jr(b.input,b.ha),5);case 5:return q=oa.j,M("kevlar_process_local_innertube_responses_killswitch")||
Au(a,q,b),oa.return(q);case 4:return(u=null==(w=b.config)?void 0:w.Ea)&&a.i.has(u)&&M("web_memoize_inflight_requests")?r=a.i.get(u):(A=JSON.stringify(b.ha),O=null!=(F=null==(E=b.ya)?void 0:E.headers)?F:{},b.ya=Object.assign({},b.ya,{headers:Object.assign({},O,c)}),N=Object.assign({},b.ya),"POST"===b.ya.method&&(N=Object.assign({},N,{body:A})),(null==(R=b.config)?0:R.kd)&&Z(b.config.kd),da=function(){return a.M.fetch(b.input,N,b.config)},r=da(),u&&a.i.set(u,r)),v(oa,r,6);
case 6:W=oa.j;if(M("web_one_platform_error_handling")&&(null==(pb=W)?0:null==(Za=pb.error)?0:Za.details))for(ma=W.error.details,H=p(ma),la=H.next();!la.done;la=H.next())fa=la.value,(ze=fa["@type"])&&-1<tu.indexOf(ze)&&(delete fa["@type"],W=fa);u&&a.i.has(u)&&a.i.delete(u);(null==(Ae=b.config)?0:Ae.ld)&&Z(b.config.ld);if(W||null==(wd=a.j)||!wd.dr(b.input,b.ha)){oa.u(7);break}return v(oa,a.j.ir(b.input,b.ha),8);case 8:W=oa.j;case 7:return Au(a,W,b),oa.return(W)}})}
function yu(a,b){var c,d,e,f;return x(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ya)?void 0:d.sessionIndex;var h=Hs({sessionIndex:e});if(!(h instanceof rf)){var k=new rf(cb);sf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},xu(b),f)))})}
function xu(a){var b={"Content-Type":"application/json"};L("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=L("EOM_VISITOR_DATA"):L("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=L("VISITOR_DATA"));M("track_webfe_innertube_auth_mismatch")&&(b["X-Youtube-Bootstrap-Logged-In"]=L("LOGGED_IN",!1));"cors"!==a&&((a=L("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=L("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=L("CHROME_CONNECTED_HEADER"))&&(b["X-Youtube-Chrome-Connected"]=
a),(a=L("DOMAIN_ADMIN_STATE"))&&(b["X-Youtube-Domain-Admin-State"]=a));return b}
;var Bu=new Ts("INNERTUBE_TRANSPORT_TOKEN");var Cu=["share/get_web_player_share_panel"],Du=["feedback"],Eu=["notification/modify_channel_preference"],Fu=["browse/edit_playlist"],Gu=["subscription/subscribe"],Hu=["subscription/unsubscribe"];function Iu(){}
t(Iu,et);Iu.prototype.l=function(){return Gu};
Iu.prototype.i=function(a){return ts(a,Uj)||void 0};
Iu.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params);c.botguardResponse&&(a.botguardResponse=c.botguardResponse);c.feature&&(a.clientFeature=c.feature)};
ea.Object.defineProperties(Iu.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Ju(){}
t(Ju,et);Ju.prototype.l=function(){return Hu};
Ju.prototype.i=function(a){return ts(a,Tj)||void 0};
Ju.prototype.j=function(a,b){b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params)};
...
Ku.prototype.i=function(a){return ts(a,Zi)||void 0};
Ku.prototype.j=function(a,b,c){a.feedbackTokens=[];b.feedbackToken&&a.feedbackTokens.push(b.feedbackToken);if(b=b.cpn||c.cpn)a.feedbackContext={cpn:b};a.isFeedbackTokenUnencrypted=!!c.is_feedback_token_unencrypted;a.shouldMerge=!1;c.extra_feedback_tokens&&(a.shouldMerge=!0,a.feedbackTokens=a.feedbackTokens.concat(c.extra_feedback_tokens))};
...
Lu.prototype.i=function(a){return ts(a,Sj)||void 0};
Lu.prototype.j=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function Mu(){}
t(Mu,et);Mu.prototype.l=function(){return Fu};
Mu.prototype.i=function(a){return ts(a,Rj)||void 0};
Mu.prototype.j=function(a,b){b.actions&&(a.actions=b.actions);b.params&&(a.params=b.params);b.playlistId&&(a.playlistId=b.playlistId)};function Nu(){}
t(Nu,et);Nu.prototype.l=function(){return Cu};
Nu.prototype.i=function(a){return ts(a,Qj)};
Nu.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Vs=new Ts("NETWORK_SLI_TOKEN");function Ou(a){this.i=a}
...
return b};
Ou[Ss]=[new Us];var Pu=new Ts("NETWORK_MANAGER_TOKEN");var Qu;function Ru(a){Sn.call(this,1,arguments);this.csn=a}
t(Ru,Sn);var ao=new Tn("screen-created",Ru),Su=[],Uu=Tu,Vu=0;function Wu(a,b,c,d,e,f,g){function h(){Or(new Q("newScreen() parent element does not have a VE - rootVe",b))}
var k=Uu(),m=new Zr({veType:b,youtubeData:f,jspbYoutubeData:void 0});f={ba:k};e&&(f.cttAuthInfo=e);M("il_via_jspb")?(e=new oj,e.j(k),pj(e,m.getAsJspb()),c&&c.visualElement?(m=new qj,c.clientScreenNonce&&D(m,2,c.clientScreenNonce),rj(m,c.visualElement.getAsJspb()),g&&D(m,4,Kj[g]),G(e,qj,5,m)):c&&h(),d&&D(e,3,d),sr(e,f,a)):(e={csn:k,pageVe:m.getAsJson()},c&&c.visualElement?(e.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(e.implicitGesture.gestureType=g)):
c&&h(),d&&(e.cloneCsn=d),a?ir("screenCreated",e,a,f):km("screenCreated",e,f));Yn(ao,new Ru(k));return k}
function Xu(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:hs(b)||void 0,
...
"UNDEFINED_CSN"===b?Yu("visualElementAttached",f,void 0,h):tr(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:hb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"===b?Yu("visualElementAttached",f,c):a?ir("visualElementAttached",c,a,f):km("visualElementAttached",c,f)}
function Tu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return dd(b,3)}
function Yu(a,b,c,d){Su.push({payloadName:a,payload:c,xa:d,options:b});Vu||(Vu=bo())}
function co(a){if(Su){for(var b=p(Su),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.xa.j(a.csn),c.payloadName){case "screenCreated":sr(c.xa,c.options);break;case "visualElementAttached":tr(c.xa,c.options);break;case "visualElementShown":or(c.xa,c.options);break;case "visualElementHidden":pr(c.xa,c.options);break;case "visualElementGestured":qr(c.xa,c.options);break;case "visualElementStateChanged":rr(c.xa,c.options);break;default:Or(new Q("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,ir(c.payloadName,c.payload,null,c.options);Su.length=0}Vu=0}
;function Zu(){this.j=new Set;this.i=new Set;this.l=new Map}
Zu.prototype.s=function(){};
Zu.prototype.clear=function(){this.j.clear();this.i.clear();this.l.clear()};
Na(Zu);function $u(){this.o=[];this.N=[];this.i=[];this.m=[];this.C=[];this.j=new Set;this.v=new Map}
$u.prototype.s=function(a){this.client=a};
function av(a,b,c){c=void 0===c?0:c;b.then(function(d){a.j.has(c)&&a.l&&a.l();var e=fs(c),f=ds(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&Xu(a.client,e,f,[$r(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&Xu(a.client,e,f,[$r(d.playerResponse.trackingParams)])}})}
function bv(a,b,c,d){d=void 0===d?0:d;if(a.j.has(d))a.o.push([b,c]);else{var e=fs(d);c=c||ds(d);e&&c&&Xu(a.client,e,c,[b])}}
$u.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=fs(void 0===c?0:c)){a=this.client;var e=$r(d);d={cttAuthInfo:hs(c)||void 0,ba:c};M("il_via_jspb")?(b=new vj,b.j(c),e=e.getAsJspb(),G(b,mj,2,e),D(b,4,Kj.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK),"UNDEFINED_CSN"===c?Yu("visualElementGestured",d,void 0,b):qr(b,d,a)):(e={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(e.clientData=b),"UNDEFINED_CSN"===c?Yu("visualElementGestured",
d,e):a?ir("visualElementGestured",e,a,d):km("visualElementGestured",e,d));b=!0}else b=!1;else b=!1;return b};
function cv(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){dv(a,b,c);var f=ds(c.layer);if(f){for(var g=p(a.o),h=g.next();!h.done;h=g.next())h=h.value,bv(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=fs(g);var m=k[0]||ds(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:hs(h)||void 0,ba:h};M("il_via_jspb")?(q=new yj,q.j(h),m=m.getAsJspb(),G(q,mj,2,m),"UNDEFINED_CSN"===h?Yu("visualElementStateChanged",k,void 0,q):rr(q,k,g)):
(m={csn:h,ve:m.getAsJson(),clientData:q},"UNDEFINED_CSN"===h?Yu("visualElementStateChanged",k,m):g?ir("visualElementStateChanged",m,g,k):km("visualElementStateChanged",m,k))}}}};
fs(c.layer)||a.l();if(c.Yb)for(var d=p(c.Yb),e=d.next();!e.done;e=d.next())av(a,e.value,c.layer);else Nr(Error("Delayed screen needs a data promise."))}
function dv(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ed?c.ed:c.layer;var e=fs(d);d=ds(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Wu(a.client,b,f,c.Xb,c.cttAuthInfo,g,c.gr)}catch(m){Qr(m,{sr:b,rootVe:d,parentVisualElement:void 0,er:e,pr:f,Xb:c.Xb});Nr(m);return}is(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Yr));for(f=b.next();!f.done;f=b.next())if(fs(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:hs(e)||void 0,ba:e,Zb:g},M("il_via_jspb")?(h=new wj,h.j(e),d=d.getAsJspb(),G(h,mj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"===e?Yu("visualElementHidden",f,void 0,h):pr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"===e?Yu("visualElementHidden",f,d):b?ir("visualElementHidden",
d,b,f):km("visualElementHidden",d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");nu({clientScreenNonce:k});Zu.getInstance().clear();d=ds(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:hs(e)||void 0,ba:e},M("il_via_jspb")?(b=new xj,b.j(e),f=d.getAsJspb(),G(b,mj,2,f),D(b,4,1),"UNDEFINED_CSN"===e?Yu("visualElementShown",k,void 0,b):or(b,k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"===
e?Yu("visualElementShown",k,b):km("visualElementShown",b,k)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.v);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&bv(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Nr(m)}}for(c=a.m.length=0;c<a.C.length;c++){e=a.C[c];try{e()}catch(m){Nr(m)}}}
;function ev(){var a,b;return x(function(c){if(1==c.i)return a=$s().resolve(Bu),a?v(c,wu(a),2):(Or(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Or(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.fr);Or(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var fv=y.caches,gv;function hv(a){var b=a.indexOf(":");return-1===b?{mc:a}:{mc:a.substring(0,b),datasyncId:a.substring(b+1)}}
function iv(){return x(function(a){if(void 0!==gv)return a.return(gv);gv=new Promise(function(b){var c;return x(function(d){switch(d.i){case 1:return ya(d,2),v(d,fv.open("test-only"),4);case 4:return v(d,fv.delete("test-only"),5);case 5:za(d,3);break;case 2:if(c=Aa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(gv)})}
function jv(a){var b,c,d,e,f,g,h;x(function(k){if(1==k.i)return v(k,iv(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return v(k,fv.keys(),3)}c=k.j;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=hv(f),h=g.datasyncId,!h||a.includes(h)||b.push(fv.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function kv(){var a,b,c,d,e,f,g;return x(function(h){if(1==h.i)return v(h,iv(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=om("cache contains other");return v(h,fv.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=hv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function lv(){try{return!!self.localStorage}catch(a){return!1}}
;function mv(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function nv(a){if(lv()){var b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=mv(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function ov(){if(!lv())return!1;var a=om(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=mv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function pv(){ev().then(function(a){a&&(zn(a),jv(a),nv(a))})}
function qv(){var a=new Jo;Qh.T(function(){var b,c,d,e;return x(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=om("clear");if(b.startsWith("V")){var g=[b];zn(g);jv(g);nv(g);return f.return()}c=ov();return v(f,kv(),3);case 3:return d=f.j,v(f,An(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.L()?pv():a.m.add("publicytnetworkstatus-online",pv,!0,void 0,void 0),f.i=0}})})}
;function rv(a){a&&(a.dataset?a.dataset[sv("loaded")]="true":a.setAttribute("data-loaded","true"))}
...
function yv(a,b,c){c=void 0===c?null:c;var d=zv(a),e=document.getElementById(d),f=e&&tv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=qq(d,b),b=""+Ra(b),Av[b]=f),g||(e=Bv(a,d,function(){tv(e,"loaded")||(rv(e),tq(d),Xk(Xa(uq,d),0))},c)))}
function Bv(a,b,c,d){d=void 0===d?null:d;var e=cf("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Cv(a){a=zv(a);var b=document.getElementById(a);b&&(uq(a),b.parentNode.removeChild(b))}
function Dv(a,b){a&&b&&(a=""+Ra(b),(a=Av[a])&&sq(a))}
function zv(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var Av={};var Ev=[],Fv=!1;function Gv(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&vs()){var a=L("PLAYER_VARS",{});if("1"!=tb(a)&&!ws(a)){var b=function(){Fv=!0;"google_ad_status"in window?uk("DCLKSTAT",1):uk("DCLKSTAT",2)};
try{xv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Ev.push(Qh.T(function(){if(!(Fv||"google_ad_status"in window)){try{Dv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Fv=!0;uk("DCLKSTAT",3)}},5E3))}}}
function Hv(){var a=Number(L("DCLKSTAT",0));return isNaN(a)?0:a}
;function Iv(){this.state=1;this.i=null}
l=Iv.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Db("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=Ab())?f.createScript(e):e,e=(new Fb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Db("From proto message. b/166824318"),d=Lb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());Lv(this,e,
d,a.program,b,c)}else Or(Error("Cannot initialize botguard without program"))};
function Lv(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,xv(c,function(){window[g]?Mv(a,d,g,e):(a.state=3,Cv(c),Or(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=cf("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Mv(a,d,g,e):(a.state=4,Or(new Q("Unable to load Botguard from JS")))):Or(new Q("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.yb()};
function Mv(a,b,c,d){a.state=5;try{var e=new vh({program:b,globalName:c,hd:M("att_web_record_metrics")});e.ud.then(function(){a.state=6;d&&d(b)});
...
l.Jb=function(a){ie(this.i);this.i=a};function Nv(){Iv.apply(this,arguments)}
t(Nv,Iv);Nv.prototype.Mb=function(){this.state=8};
Nv.prototype.yb=function(){return B("yt.abuse.playerAttLoader")};
Nv.prototype.Jb=function(a){ie(B("yt.abuse.playerAttLoader"));z("yt.abuse.playerAttLoader",a);a&&z("yt.abuse.playerAttLoaderRun",function(b){return a.snapshot(b)})};var Ov=new Nv;var Pv=new Iv;function Qv(){return M("use_player_abuse_bg_library")?Ov.isInitialized():Pv.isInitialized()}
function Rv(a){a=void 0===a?{}:a;M("use_player_abuse_bg_library")?(a=void 0===a?{}:a,a=Ov.invoke(a)):a=Pv.invoke(a);return a}
...
e=Wl(d,Tv(this,a.Ga));this.i[a.Ra]=Object.assign({},a.Ga,{Bb:d,hb:e})}}
function Uv(a){var b=Array.from(a.i.keys()).sort(function(d,e){return Tv(a,a.i[e])-Tv(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.hb||c.lb||(a.l.fa(c.hb),Wl(c.Bb,10))}
Sv.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.hb||b.lb||this.l.fa(b.hb),b.lb=!0;this.j.resolve()};
function Tv(a,b){var c;return null!=(c=b.priority)?c:a.m}
;function Vv(a){this.state=a;this.plugins=[];this.s=void 0}
Vv.prototype.install=function(){this.plugins.push.apply(this.plugins,ia(Ja.apply(0,arguments)))};
Vv.prototype.uninstall=function(){var a=this;Ja.apply(0,arguments).forEach(function(b){b=a.plugins.indexOf(b);-1<b&&a.plugins.splice(b,1)})};
Vv.prototype.transition=function(a,b){var c=this,d=this.C.find(function(f){return f.from===c.state&&f.F===a});
if(d){this.l&&(Uv(this.l),this.l=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(Wv(this,e,this.s),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function Wv(a,b,c){return function(){var d=Ja.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
t(Yv,Vv);Yv.prototype.j=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
Yv.prototype.i=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
Yv.prototype.m=function(a,b){a(null==b?void 0:b.event)};
Yv.prototype.o=function(a,b){a(null==b?void 0:b.event)};function Zv(){this.i=new Xv;this.j=new Yv}
Zv.prototype.install=function(){var a=Ja.apply(0,arguments);this.i.install.apply(this.i,ia(a));this.j.install.apply(this.j,ia(a))};function $v(){Zv.call(this);var a={};this.install((a.document_disposed={callback:this.l},a));a={};this.install((a.flush_logs={callback:this.m},a))}
var aw;t($v,Zv);$v.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new lj,b=fs();b&&D(a,1,b);b=new Ij;Ud(b,lj,380,Jj,a);nr(b);M("web_fp_via_jspb_and_json")&&km("finalPayload",{csn:fs()})}else km("finalPayload",{csn:fs()})};
$v.prototype.l=function(){Sr(Tr)};function bw(){}
bw.getInstance=function(){var a=B("ytglobal.storage_");a||(a=new bw,z("ytglobal.storage_",a));return a};
bw.prototype.estimate=function(){var a,b,c;return x(function(d){a=navigator;return(null==(b=a.storage)?0:b.estimate)?d.return(a.storage.estimate()):(null==(c=a.webkitTemporaryStorage)?0:c.queryUsageAndQuota)?d.return(cw()):d.return()})};
...
z("ytglobal.storageClass_",bw);function im(a,b){var c=this;this.handleError=a;this.i=b;this.j=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.j=!0});
...
function dw(a,b){bw.getInstance().estimate().then(function(c){c=Object.assign({},b,{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:ew(null==c?void 0:c.usage),deviceStorageQuotaMbytes:ew(null==c?void 0:c.quota)});a.i("idbQuotaExceeded",c)})}
function ew(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;function fw(a,b,c){J.call(this);var d=this;c=c||L("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.targetOrigin="*";this.m=c;this.sessionId=null;this.channel="widget";this.G=!!a;this.v=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.G&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(fw,J);fw.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){Ek(d)}}};
fw.prototype.D=function(){window.removeEventListener("message",this.v);J.prototype.D.call(this)};function gw(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new fw(!!L("WIDGET_ID_ENFORCE")),b=this.gd.bind(this);a.o=b;a.s=null;this.i.channel="widget";if(a=L("WIDGET_ID"))this.i.sessionId=a}
l=gw.prototype;l.gd=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,hw(this,a)),this.l[a]=!0)):this.Nb(a,b,c)};
l.Nb=function(){};
function hw(a,b){return function(c){return a.sendMessage(b,c)}}
...
;function pw(a){gw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.rd.bind(this));this.addEventListener("onVolumeChange",this.sd.bind(this));this.addEventListener("onApiChange",this.md.bind(this));this.addEventListener("onPlaybackQualityChange",this.od.bind(this));this.addEventListener("onPlaybackRateChange",this.pd.bind(this));this.addEventListener("onStateChange",this.qd.bind(this));this.addEventListener("onWebglSettingsChanged",
this.td.bind(this))}
t(pw,gw);l=pw.prototype;
l.Nb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&mw(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=nw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=nw(e);break;case "loadPlaylist":case "cuePlaylist":e=ow(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);mw(a)&&iw(this,this.wb())}};
l.onReady=function(){var a=this.Sc.bind(this);this.i.j=a;a=this.api.getVideoData();if(!a.isPlayable){a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?kw[a]||b:b).toString())}};
...
l.od=function(a){iw(this,{playbackQuality:a})};
l.pd=function(a){iw(this,{playbackRate:a})};
...
l.sd=function(){iw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
l.td=function(){var a={sphericalProperties:this.api.getSphericalProperties()};iw(this,a)};
l.dispose=function(){gw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function qw(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.oc,this)}
t(qw,J);l=qw.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.za("RECEIVING"))};
l.za=function(a,b){this.started&&!this.i()&&this.connection.za(a,b)};
l.oc=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=rw(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=sw(a,c))&&this.za(a,c))}}};
...
l.D=function(){var a=this.connection;a.i()||ni(a.j,"command",this.oc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function tw(a,b){qw.call(this,b);this.api=a;this.start()}
...
tw.prototype.vb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return qw.prototype.vb.call(this,a,b)};
tw.prototype.D=function(){qw.prototype.D.call(this);delete this.api};function uw(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);ke(this,this.j)}
Ya(uw,J);uw.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
uw.prototype.m=function(a,b){this.i()||this.j.ta.apply(this.j,arguments)};function vw(a,b,c){uw.call(this);this.l=a;this.destination=b;this.id=c}
t(vw,uw);vw.prototype.za=function(a,b){this.i()||this.l.za(this.destination,this.id,a,b)};
vw.prototype.D=function(){this.destination=this.l=null;uw.prototype.D.call(this)};function ww(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=dq(window,"message",this.l.bind(this));this.connection=new vw(this,a,b);ke(this,this.connection)}
t(ww,J);ww.prototype.za=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(JSON.stringify(a),this.origin))};
...
function Aw(a){var b=Bw(a),c=document.getElementById(b),d=c&&tv(c,"loaded");d||c&&!d||(c=Cw(a,b,function(){tv(c,"loaded")||(rv(c),tq(b),Xk(Xa(uq,b),0))}))}
...
function Bw(a){var b=cf("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
...
t(Ew,Dw);function Fw(a,b,c,d){J.call(this);var e=this;this.v=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.W=this.s=null;this.K=new K;this.j={};this.R=this.X=this.elementId=this.va=this.config=null;this.P=!1;this.m=this.G=null;this.la={};this.Wa=["onReady"];this.lastError=null;this.Ia=NaN;this.J={};this.Xa=new Ew(this);this.U=0;this.l=this.o=a;ke(this,this.K);Gw(this);Hw(this);ke(this,this.Xa);c?this.U=Xk(function(){e.loadNewVideoConfig(c)},0):d&&(Iw(this),Jw(this))}
t(Fw,J);l=Fw.prototype;l.getId=function(){return this.v};
l.loadNewVideoConfig=function(a){if(!this.i()){this.U&&(Yk(this.U),this.U=0);var b=a||{};b instanceof xw||(b=new xw(b));this.config=b;this.setConfig(a);Jw(this);this.isReady()&&Kw(this)}};
...
function Nw(a){var b=!0,c=Ow(a);c&&a.config&&(a=Pw(a),b=tv(c,"version")===a);return b&&!!B("yt.player.Application.create")}
...
a.P=!0;b?a.G():(xv(Pw(a),a.G),(b=Tw(a))&&zw(b),Uw(a)&&!c&&z("yt.player.Application.create",null))}}}
function Ow(a){var b=bf(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function Qw(a){if(!a.i()){var b=Ow(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Sw(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Vw(a)}else a.Ia=Xk(function(){Qw(a)},50)}}
function Vw(a){Gw(a);a.da=!0;var b=Ow(a);if(b){a.s=Ww(a,b,"addEventListener");a.W=Ww(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Ww(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.s&&a.s(g,a.j[g]);Kw(a);a.X&&a.X(a.api);a.K.ta("onReady",a.api)}
function Ww(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Or(f))}}}
function Gw(a){a.da=!1;if(a.W)for(var b in a.j)a.j.hasOwnProperty(b)&&a.W(b,a.j[b]);for(var c in a.J)a.J.hasOwnProperty(c)&&Yk(Number(c));a.J={};a.s=null;a.W=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Hw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){tq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){tq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=Mw(this,b);d&&(0<=eb(this.Wa,a)||this.j[a]||(b=Xw(this,a),this.s&&this.s(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&Xk(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=Mw(this,b))&&ni(this.K,a,b)};
function Mw(a,b){var c=b;if("string"===typeof b){if(a.la[b])return a.la[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){Nr(f)}};
a.la[b]=c}return c?c:null}
function Xw(a,b){var c="ytPlayer"+b+a.v;a.j[b]=c;y[c]=function(d){var e=Xk(function(){if(!a.i()){try{a.K.ta(b,null!=d?d:void 0)}catch(h){Or(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.v,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
...
l.cancel=function(){this.G&&Dv(Pw(this),this.G);Yk(this.Ia);this.P=!1};
l.D=function(){Rw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Nr(b)}this.la=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.va=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
function Sw(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===Kk(c||"","&")[b]}
...
;var Yw={},Zw="player_uid_"+(1E9*Math.random()>>>0);function $w(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?bf(c):c;var e=Zw+"_"+Ra(c),f=Yw[e];if(f&&d)return ax(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Fw(c,e,a,b);Yw[e]=f;tq("player-added",f.api);le(f,function(){delete Yw[f.getId()]});
return f.api}
...
function hx(){bx&&bx.sendAbandonmentPing&&bx.sendAbandonmentPing();L("PL_ATT")&&(M("use_player_abuse_bg_library")?Ov.dispose():Pv.dispose());for(var a=Qh,b=0,c=Ev.length;b<c;b++)a.fa(Ev[b]);Ev.length=0;Cv("//static.doubleclick.net/instream/ad_status.js");Fv=!1;uk("DCLKSTAT",0);je(dx,cx);bx&&(bx.removeEventListener("onVideoDataChange",ex),bx.destroy())}
;function ix(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;vs()&&nl(a,b,c)}
;function jx(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=L("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=L("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=oc(window.location.href);g&&f.push(g);g=oc(d);if(0<=eb(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),fc(f,d),d=f.href),d&&(d=pc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:fs()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
ix(d,b,h)}else ix(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Ih:r;a:{r=void 0===r?Ih:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Gh&&m.isValid(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var w=Qb(r);else{b:if(yh){try{w=new URL(r)}catch(u){w="https:";break b}w=w.protocol}else c:{w=document.createElement("a");try{w.href=r}catch(u){w=void 0;
...
z("writeEmbed",function(){var a=L("PLAYER_CONFIG");if(!a){var b=L("PLAYER_VARS");b&&(a={args:b})}Fs(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=L("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);hu();c=L("WEB_PLAYER_CONTEXT_CONFIGS").WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=Pk(window.location.href);
d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}bx=$w(a,c);bx.addEventListener("onVideoDataChange",ex);bx.addEventListener("onReady",gx);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?dx=new pw(bx):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(cx=new ww(window.parent,a,b),dx=new tw(bx,cx.connection));Gv();M("ytidb_create_logger_embed_killswitch")||hm();a={};aw||(aw=new $v);aw.install((a.flush_logs={callback:function(){Tq()}},a));
M("embeds_web_enable_new_nwl")?Po():Xo();M("ytidb_clear_embedded_player")&&Qh.T(function(){var e;if(!Qu){var f=$s(),g={Gb:Pu,yc:Ou};f.providers.set(g.Gb,g);g={Vb:{feedbackEndpoint:at(Ku),modifyChannelNotificationPreferenceEndpoint:at(Lu),playlistEditEndpoint:at(Mu),subscribeEndpoint:at(Iu),unsubscribeEndpoint:at(Ju),webPlayerShareEntityServiceEndpoint:at(Nu)}};var h=Os.getInstance(),k={};h&&(k.client_location=h);if(void 0===m){Gs.i||(Gs.i=new Gs);var m=Gs.i}void 0===e&&(e=f.resolve(Pu));vu(g,e,m,
k);m={Gb:Bu,zc:uu.i};f.providers.set(m.Gb,m);Qu=f.resolve(Bu)}qv()})});
var kx=Ck(function(){ou();var a=rl.getInstance(),b=ul(119),c=1<window.devicePixelRatio;if(document.body&&ai(document.body,"exp-invert-logo"))if(c&&!ai(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!ai(d,"inverted-hdpi")){var e=Zh(d);$h(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&ai(document.body,"inverted-hdpi")&&bi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=vl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete ql[b]:(c=d.toString(16),
ql[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in ql)d.push(f+"="+encodeURIComponent(String(ql[f])));nl(b,d.join("&"),63072E3,a.j,c)}$u.i||($u.i=new $u);a=$u.i;f=16623;var g=void 0===g?{}:g;Object.values(ls).includes(f)||(Or(new Q("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.o=[];a.N=[];g.Yb?cv(a,f,g):dv(a,f,g)}),lx=Ck(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?
hx():a.persisted||hx()}),mx=Ck(hx);
window.addEventListener?(window.addEventListener("load",kx),window.addEventListener("pagehide",lx)):window.attachEvent&&(window.attachEvent("onload",kx),window.attachEvent("onunload",mx));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Qv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Rv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Hv);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||jx);
